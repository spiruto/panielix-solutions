export default function WhatsAppFab() {
  return (
    <a
      ...
      href="https://wa.me/13075550100"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-22 md:bottom-5 right-2 md:right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-transform hover:scale-110"
    >
      <svg xmlns="http://www.w3.org/2000/svg" width={128} height={128} viewBox="-1 0 258 258">
        <defs>
